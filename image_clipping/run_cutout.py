#!/usr/bin/env python3
"""
BiRefNet CUDA Foreground Cutout Tool
Clips figures from images using BiRefNet with CUDA acceleration.
...
DEFAULT_FG_DIR = "/home/elicer/ARTI/image_clipping/clipped_images_fg"
DEFAULT_BG_DIR = "/home/elicer/ARTI/image_clipping/clipped_images_bg"
...
def make_session(model_path: str) -> ort.InferenceSession:
    ...
    # CUDA provider options for optimization
    ...
    provider_options = [
        cuda_provider_options,  # CUDA EP options
        {}   # CPU fallback
    ]
...
def main():
    parser = argparse.ArgumentParser(
        description="BiRefNet CUDA Foreground/Background Cutout Tool",
